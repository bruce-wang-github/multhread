 ...
 *@author: ddys
 */
public class TaskMulThreadServiceTest extends TestCase {
    ...
    public void testExecute() throws Exception {
        ...
        IMulThreadService<String,Boolean> mulThreadService = new TaskMulThreadService(new ITaskHandle<String,Boolean>() {
