 ...
 *@author: XWK
 */
public class SelectTaskMulThreadServiceTest extends TestCase {

    public void testExecute() throws Exception {
        IMulThreadService<String,Boolean> mulThreadService = new SelectTaskMulThreadService(new ISelectTask<String,Boolean>() {
            /**
             * Created with IntelliJ IDEA.
             * 执行任务，返回所有执行的结果
